    ...
    <main style={{
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <motion.div whileHover={{ y: -5 }} style={{backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-primary)'}} className="p-6 rounded-[32px] border shadow-xl shadow-green-500/5 relative overflow-hidden group hover:shadow-2xl transition-all">
            ...
            <p className="text-[10px] font-black text-green-600 dark:text-green-400 uppercase tracking-widest mb-2">{t.income}</p>
            <p className="text-2xl font-black" style={{color: 'var(--text-primary)'}}>
              {currency === 'RUB' ? '+' : ''}{formatVal(inc).text} {formatVal(inc).sign}
            </p>
          </motion.div>
          
          <motion.div whileHover={{ y: -5 }} style={{backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-primary)'}} className="p-6 rounded-[32px] border shadow-xl shadow-red-500/5 relative overflow-hidden group hover:shadow-2xl transition-all">
            ...
            <p className="text-[10px] font-black text-red-600 dark:text-red-400 uppercase tracking-widest mb-2">{t.expense}</p>
            <p className="text-2xl font-black" style={{color: 'var(--text-primary)'}}>
